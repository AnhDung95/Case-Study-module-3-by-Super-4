                    ...
                    <c:forEach begin="0" end="${books.size()-1}" var="i">
                        <div class="col-md-4 col-xs-6">
                            <div class="book">
                                ...
                                <div class="book-body">
                                    <p class="book-publishers">${books.get(i).publishers}</p>
                                    <h3 class="book-name"><a href="/home?action=detail&id=${books.get(i).id}">${books.get(i).name}</a></h3>
                                    <h4 class="book-price">$ ${books.get(i).price} VND <del class="book-old-price">${books.get(i).price * 1.1}</del></h4>
